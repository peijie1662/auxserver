...
public class Message {
	...
	public String getSrcGh() {
		return srcGh;
	}

	public void setSrcGh(String srcGh) {
		this.srcGh = srcGh;
	}
	...
	public String getTargetGh() {
		return targetGh;
	}

	public void setTargetGh(String targetGh) {
		this.targetGh = targetGh;
	}
